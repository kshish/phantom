...
def filter_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        container=container,
        conditions=[
            ["filtered-data:filter_in_public_ips:condition_1:my_geolocate:action_result.data.*.country_name", "in", "custom_list:countries"]
        ],
    ...
    matched_artifacts_2, matched_results_2 = phantom.condition(
        container=container,
        conditions=[
            ["filtered-data:filter_in_public_ips:condition_1:my_geolocate:action_result.data.*.country_name", "not in", "custom_list:countries"]
        ],
