...
def my_geolocate(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    ################################################################################
    # this is a comment about this block
    ################################################################################
...
def debug_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    my_geolocate_result_data = phantom.collect2(container=container, datapath=["my_geolocate:action_result.data.*.country_name","my_geolocate:action_result.parameter.ip","my_geolocate:action_result.data","my_geolocate:action_result.parameter.context.artifact_id"], action_results=results)
    ...
    parameters.append({
        ...
        "input_5": my_geolocate_result_item_2,
        "input_6": None,
        "input_7": None,
        "input_8": None,
        "input_9": None,
...
def decision_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    if found_match_1:
        playbook_demo_sep_2025_child_pb_1(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def list_merge_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    container_artifact_data = phantom.collect2(container=container, datapath=["artifact:*.cef.destinationAddress","artifact:*.cef.deviceAddress","artifact:*.cef.sourceAddress","artifact:*.cef.myOwn","artifact:*.id"])
...
def playbook_demo_sep_2025_child_pb_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    # call playbook "chris/demo sep 2025 child pb", returns the playbook_run_id
    playbook_run_id = phantom.playbook("chris/demo sep 2025 child pb", container=container, name="playbook_demo_sep_2025_child_pb_1", callback=decision_3, inputs=inputs)
...
def decision_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    found_match_1 = phantom.decision(
        container=container,
        conditions=[
            ["playbook_demo_sep_2025_child_pb_1:playbook_output:risk_score", ">", 80]
        ],
        conditions_dps=[
            ["playbook_demo_sep_2025_child_pb_1:playbook_output:risk_score", ">", 80]
        ],
    ...
    # call connected blocks if condition 1 matched
    if found_match_1:
        add_comment_add_note_8(action=action, success=success, container=container, results=results, handle=handle)
        return
...
@phantom.playbook_block()
def add_comment_add_note_8(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("add_comment_add_note_8() called")

    playbook_demo_sep_2025_child_pb_1_output_risk_score = phantom.collect2(container=container, datapath=["playbook_demo_sep_2025_child_pb_1:playbook_output:risk_score"])

    playbook_demo_sep_2025_child_pb_1_output_risk_score_values = [item[0] for item in playbook_demo_sep_2025_child_pb_1_output_risk_score]
    ...
    phantom.add_note(container=container, content=playbook_demo_sep_2025_child_pb_1_output_risk_score_values, note_format="markdown", note_type="general", title="High risk score!!!")

    debug_9(container=container)
...
def debug_9(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_demo_sep_2025_child_pb_1_output_answered_at = phantom.collect2(container=container, datapath=["playbook_demo_sep_2025_child_pb_1:playbook_output:answered_at"])

    playbook_demo_sep_2025_child_pb_1_output_answered_at_values = [item[0] for item in playbook_demo_sep_2025_child_pb_1_output_answered_at]

    parameters = []

    parameters.append({
        "input_1": playbook_demo_sep_2025_child_pb_1_output_answered_at_values,
        "input_2": None,
        "input_3": None,
        "input_4": None,
        "input_5": None,
...
def pin_7(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.pin(container=container, data=filtered_result_0_parameter_ip, message="Privte IP", pin_style="grey", pin_type="card")
