...
def format_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    template = """Origin in {0} is low risk, closing event."""
    ...
    add_comment_set_status_5(container=container)

    return

def add_comment_set_status_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
def playbook_local_Log_File_Hashes_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('playbook_local_Log_File_Hashes_1() called')
    
    # call playbook "local/Log File Hashes", returns the playbook_run_id
    playbook_run_id = phantom.playbook("local/Log File Hashes", container=container)
...
def decision_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_1 or matched_results_1:
        ...
        playbook_local_Log_File_Hashes_1(action=action, success=success, container=container, results=results, handle=handle)
        return
