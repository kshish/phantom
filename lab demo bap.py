...
def filter_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched_artifacts_2, matched_results_2 = phantom.condition(
        container=container,
        conditions=[
            ["filtered-data:filter_out_none:condition_1:my_geo_locate:action_result.data.*.country_name", "not in", "custom_list:faveCountries"]
        ],
...
def pin_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    filtered_result_0_data_filter_2 = phantom.collect2(container=container, datapath=["filtered-data:filter_2:condition_1:my_geo_locate:action_result.parameter.ip","filtered-data:filter_2:condition_1:my_geo_locate:action_result.data.*.country_name"])
...
def pin_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    format_ip_and_country_list__as_list = phantom.get_format_data(name="format_ip_and_country_list__as_list")
    ...
    phantom.pin(container=container, data=format_ip_and_country_list__as_list, message="NOT IN LIST", pin_style="red", pin_type="card")
