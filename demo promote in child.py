...
def prompt_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    user = "Administrator"
    message = """The other analyst's gut says {0}\nand here's the filtered list:\n\n{1}\n"""

    # parameter list for template variable replacement
    parameters = [
        "playbook_input:gut_response",
        "playbook_input:ip_list"
    ]

    # responses
    response_types = [
        {
            "prompt": "What is your response to all of this?",
            "options": {
                "type": "message",
            },
        }
...
def on_finish(container, summary):
    ...
    output = {
        "somethought": prompt_1_summary_responses_0,
    }
