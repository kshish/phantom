...
def pin_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.pin(container=container, data=playbook_input_countries_values, message="Countries are from outside our list", pin_style="red", pin_type="card")
...
def add_note_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.add_note(container=container, content=playbook_input_ips_values, note_format="markdown", note_type="general", title="Here's the IP(s)")
...
def prompt_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    response_types = [
        {
            "prompt": "What do you think about the reason",
            "options": {
                "type": "message",
            },
        }
