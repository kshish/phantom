...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    found_match_1 = phantom.decision(
        ...
        conditions=[
            ["filtered-data:filter_out_private_ips:condition_1:my_geolocate:action_result.data.*.country_name", "!=", "United States"],
            ["filtered-data:filter_out_private_ips:condition_1:my_geolocate:action_result.data.*.country_name", "!=", "Canada"],
            ["filtered-data:filter_out_private_ips:condition_1:my_geolocate:action_result.data.*.country_name", "!=", "Costa Rica"]
        ],
        delimiter=None)
...
def format_ip_and_country_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # parameter list for template variable replacement
    parameters = [
        "filtered-data:filter_out_private_ips:condition_1:my_geolocate:action_result.parameter.ip",
        "filtered-data:filter_out_private_ips:condition_1:my_geolocate:action_result.data.*.country_name"
    ]
