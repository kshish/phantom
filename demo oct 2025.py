...
def evaluate_response(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    if found_match_1:
        playbook_demo_oct_2025_child_pb_1(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def filter_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    matched_artifacts_2, matched_results_2 = phantom.condition(
        container=container,
        conditions=[
            ["my_geolocate_blagh:action_result.data.*.country_name", "==", ""]
        ],
        conditions_dps=[
            ["my_geolocate_blagh:action_result.data.*.country_name", "==", ""]
        ],
...
def format_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    # parameter list for template variable replacement
    parameters = [
        "filtered-data:filter_2:condition_2:my_geolocate_blagh:action_result.parameter.ip",
        "filtered-data:filter_2:condition_2:my_geolocate_blagh:action_result.data.*.country_name",
        "filtered-data:filter_2:condition_2:my_geolocate_blagh:action_result.data.*.country_iso_code"
    ]
...
@phantom.playbook_block()
def playbook_demo_oct_2025_child_pb_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("playbook_demo_oct_2025_child_pb_1() called")

    prompt_1_result_data = phantom.collect2(container=container, datapath=["prompt_1:action_result.summary.responses.1"], action_results=results)
    filtered_result_0_data_filter_2 = phantom.collect2(container=container, datapath=["filtered-data:filter_2:condition_2:my_geolocate_blagh:action_result.data.*.country_name","filtered-data:filter_2:condition_2:my_geolocate_blagh:action_result.parameter.ip"])
    ...
    inputs = {
        ...
        "pin_msg": filtered_result_0_data___country_name,
        "pin_data": filtered_result_0_parameter_ip,
    }
    ...
    # call playbook "chris/demo oct 2025 child pb", returns the playbook_run_id
    playbook_run_id = phantom.playbook("chris/demo oct 2025 child pb", container=container, name="playbook_demo_oct_2025_child_pb_1", callback=decision_5, inputs=inputs)
...
def decision_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    found_match_1 = phantom.decision(
        container=container,
        conditions=[
            ["playbook_demo_oct_2025_child_pb_1:playbook_output:risk_score", ">=", 100]
        ],
        conditions_dps=[
            ["playbook_demo_oct_2025_child_pb_1:playbook_output:risk_score", ">=", 100]
        ],
    ...
    # call connected blocks if condition 1 matched
    if found_match_1:
        format_high_risk_score_msg(action=action, success=success, container=container, results=results, handle=handle)
        return
...
@phantom.playbook_block()
def format_high_risk_score_msg(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("format_high_risk_score_msg() called")

    template = """Warning!!! High Risk Score!\nScore: {0}\n"""

    # parameter list for template variable replacement
    parameters = [
        "playbook_demo_oct_2025_child_pb_1:playbook_output:risk_score"
    ]
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="format_high_risk_score_msg")
...
def add_note_11(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_demo_oct_2025_child_pb_1_output_notes = phantom.collect2(container=container, datapath=["playbook_demo_oct_2025_child_pb_1:playbook_output:notes"])
    format_high_risk_score_msg = phantom.get_format_data(name="format_high_risk_score_msg")

    playbook_demo_oct_2025_child_pb_1_output_notes_values = [item[0] for item in playbook_demo_oct_2025_child_pb_1_output_notes]
...
def filter_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        container=container,
        conditions=[
            ["filtered-data:filter_1:condition_1:my_geolocate_blagh:action_result.data.*.country_iso_code", "in", "custom_list:Countries"]
        ],
        conditions_dps=[
            ["filtered-data:filter_1:condition_1:my_geolocate_blagh:action_result.data.*.country_iso_code", "in", "custom_list:Countries"]
        ],
    ...
    matched_artifacts_2, matched_results_2 = phantom.condition(
        container=container,
        conditions=[
            ["filtered-data:filter_1:condition_1:my_geolocate_blagh:action_result.data.*.country_iso_code", "not in", "custom_list:Countries"]
        ],
        conditions_dps=[
            ["filtered-data:filter_1:condition_1:my_geolocate_blagh:action_result.data.*.country_iso_code", "not in", "custom_list:Countries"]
        ],
...
def pin_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    filtered_result_0_data_filter_2 = phantom.collect2(container=container, datapath=["filtered-data:filter_2:condition_1:my_geolocate_blagh:action_result.parameter.ip","filtered-data:filter_2:condition_1:my_geolocate_blagh:action_result.data.*.country_name"])
