...
def on_start(container):
    ...
    # call 'set_severity_promote_to_case_1' block
    set_severity_promote_to_case_1(container=container)
...
@phantom.playbook_block()
def set_severity_promote_to_case_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("set_severity_promote_to_case_1() called")
...
def pin_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.pin(container=container, data=playbook_input_countries_values, message=playbook_input_reason_for_high_severity_values, pin_style="red", pin_type="card")
...
def add_comment_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.comment(container=container, comment=playbook_input_ips_values)
...
def on_finish(container, summary):
    ...
    prompt_1_result_data = phantom.collect2(container=container, datapath=["prompt_1:action_result.summary.responses.0","prompt_1:action_result.summary.answered_at"])

    prompt_1_summary_responses_0 = [item[0] for item in prompt_1_result_data]
    prompt_1_summary_answered_at = [item[1] for item in prompt_1_result_data]

    output = {
        "risk_score": prompt_1_summary_responses_0,
        "answered_at": prompt_1_summary_answered_at,
    }
