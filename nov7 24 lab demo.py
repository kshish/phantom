...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    found_match_1 = phantom.decision(
        ...
        conditions=[
            ...
            ["my_geolocate:action_result.data.*.country_name", "!=", "Belgium"],
            ["my_geolocate:action_result.data.*.country_name", "!=", "Norway"]
        ],
        delimiter=None)
...
def list_merge_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.custom_function(custom_function="community/list_merge", parameters=parameters, name="list_merge_4")
