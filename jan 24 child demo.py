...
def pin_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.pin(container=container, data=playbook_input_countries_values, message=playbook_input_ip_values, pin_style="red", pin_type="card")
...
def prompt_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    user = "Administrator"
    message = """The email address is {0}"""

    # parameter list for template variable replacement
    parameters = [
        "playbook_input:emailaddress"
    ]

    # responses
    response_types = [
        {
            "prompt": "Please enter in a risk score",
            "options": {
                "type": "range",
                "min": 1,
                "max": 100,
