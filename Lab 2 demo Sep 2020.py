...
def geolocate_ip_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="geolocate ip", parameters=parameters, assets=['maxmind'], callback=send_note, name="geolocate_ip_1")

    return

def send_note(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('send_note() called')
    ...
    # build parameters list for 'send_note' call
    for container_item in container_data:
    ...
    phantom.act(action="send email", parameters=parameters, assets=['smtp'], name="send_note", parent_action=action)
