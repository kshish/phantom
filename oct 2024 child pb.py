...
def on_start(container):
    ...
    # call 'set_sensitivity_add_comment_2' block
    set_sensitivity_add_comment_2(container=container)
...
@phantom.playbook_block()
def set_sensitivity_add_comment_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("set_sensitivity_add_comment_2() called")
...
def pin_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.pin(container=container, data=playbook_input_countries_values, message="There are IP(s) outside list", pin_style="red", pin_type="card")
...
def prompt_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    user = None
    role = "Administrator"
    message = """Reason from SOC analyst {0}"""
