...
def geolocate_ip_1_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    execute_program_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=filtered_artifacts, filtered_results=filtered_results)
...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    found_match_1 = phantom.decision(
        ...
        conditions=[
            ...
            ["filtered-data:filter_1:condition_1:geolocate_ip_1:action_result.data.*.country_name", "!=", "China"]
        ],
        delimiter=None)
...
def prompt_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    user = None
    role = "Administrator"
    message = """The {0} event with severity {1} has IP(s) outside our list.\n\n{2}\n"""
    ...
    phantom.prompt2(container=container, user=user, role=role, message=message, respond_in_mins=1, name="prompt_1", parameters=parameters, response_types=response_types, callback=decision_3, drop_none=True)
...
def decision_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call connected blocks if condition 1 matched
    if found_match_1:
        playbook_aug142023_child_demo_1(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def list_merge_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    container_artifact_data = phantom.collect2(container=container, datapath=["artifact:*.cef.destinationAddress","artifact:*.cef.sourceAddress","artifact:*.cef.myIpAddress","artifact:*.id"])
...
@phantom.playbook_block()
def playbook_aug142023_child_demo_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug("playbook_aug142023_child_demo_1() called")
    ...
    # call playbook "Chris/aug142023 child demo", returns the playbook_run_id
    playbook_run_id = phantom.playbook("Chris/aug142023 child demo", container=container, name="playbook_aug142023_child_demo_1", callback=add_comment_5, inputs=inputs)
...
def add_comment_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    playbook_aug142023_child_demo_1_output_their_thoughts = phantom.collect2(container=container, datapath=["playbook_aug142023_child_demo_1:playbook_output:their_thoughts"])

    playbook_aug142023_child_demo_1_output_their_thoughts_values = [item[0] for item in playbook_aug142023_child_demo_1_output_their_thoughts]
    ...
    phantom.comment(container=container, comment=playbook_aug142023_child_demo_1_output_their_thoughts_values)
