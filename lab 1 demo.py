...
def pin_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.pin(container=container, message="Country is ", data="U.S.", pin_type="card_small", pin_style="white")
...
def pin_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.pin(container=container, message="Country is:", data="Not U.S.", pin_type="card_small", pin_style="white")
...
def add_comment_pin_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('add_comment_pin_3() called')

    results_data_1 = phantom.collect2(container=container, datapath=['geolocate_ip_1:action_result.data.*.country_name', 'geolocate_ip_1:action_result.data.*'], action_results=results)
    ...
    phantom.pin(container=container, message="", data=results_item_1_1, pin_type="", pin_style="")
